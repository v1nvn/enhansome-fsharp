...
* [F# main repository](https://github.com/dotnet/fsharp) ⭐ 4,269 | 🐛 1,309 | 🌐 F# | 📅 2026-03-16
...
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [ASP.NET Core Blazor](https://github.com/dotnet/aspnetcore/tree/main/src/Components) ⭐ 37,776 \| 🐛 3,813 \| 🌐 C# \| 📅 2026-03-16                                                                                                                                | [Bolero](https://github.com/fsbolero/Bolero) ⭐ 1,123 \| 🐛 73 \| 🌐 F# \| 📅 2025-10-26                                                                                                                                                                                                                 |
| [ASP.NET Core](https://github.com/dotnet/aspnetcore) ⭐ 37,776 \| 🐛 3,813 \| 🌐 C# \| 📅 2026-03-16                                                                                                                                                                | [Giraffe](https://github.com/giraffe-fsharp/Giraffe) ⭐ 2,230 \| 🐛 44 \| 🌐 F# \| 📅 2026-03-15 (+ optionally [Saturn](https://github.com/SaturnFramework/Saturn) ⭐ 725 \| 🐛 55 \| 🌐 F# \| 📅 2024-07-31)<br/>[Oxpecker](https://github.com/Lanayx/Oxpecker) ⭐ 403 \| 🐛 10 \| 🌐 F# \| 📅 2026-02-13 |
| [Avalonia](https://github.com/AvaloniaUI/Avalonia) ⭐ 30,256 \| 🐛 1,916 \| 🌐 C# \| 📅 2026-03-15                                                                                                                                                                  | [Avalonia.FuncUI](https://github.com/fsprojects/Avalonia.FuncUI) ⭐ 1,195 \| 🐛 16 \| 🌐 F# \| 📅 2026-03-15                                                                                                                                                                                             |
| [MAUI](https://github.com/dotnet/maui) ⭐ 23,210 \| 🐛 4,388 \| 🌐 C# \| 📅 2026-03-16/[Xamarin.Forms](https://github.com/xamarin/Xamarin.Forms) ⚠️ Archived                                                                                                        | [Fabulous](https://github.com/fabulous-dev/Fabulous) ⭐ 1,254 \| 🐛 13 \| 🌐 F# \| 📅 2025-11-14                                                                                                                                                                                                         |
| [MSTest](https://github.com/microsoft/testfx) ⭐ 994 \| 🐛 227 \| 🌐 C# \| 📅 2026-03-15/[NUnit](https://github.com/nunit/nunit) ⭐ 2,612 \| 🐛 253 \| 🌐 C# \| 📅 2026-03-15/[xUnit.net](https://github.com/xunit/xunit) ⭐ 4,543 \| 🐛 59 \| 🌐 C# \| 📅 2026-03-13 | [FsUnit](https://github.com/fsprojects/FsUnit) ⭐ 444 \| 🐛 6 \| 🌐 F# \| 📅 2025-07-11                                                                                                                                                                                                                  |
| [System.Text.Json](https://github.com/dotnet/runtime/tree/main/src/libraries/System.Text.Json) ⭐ 17,738 \| 🐛 8,312 \| 🌐 C# \| 📅 2026-03-16                                                                                                                      | [FSharp.SystemTextJson](https://github.com/Tarmil/FSharp.SystemTextJson) ⭐ 365 \| 🐛 42 \| 🌐 F# \| 📅 2026-03-04                                                                                                                                                                                       |
| [WPF](https://github.com/dotnet/wpf) ⭐ 7,596 \| 🐛 1,622 \| 🌐 C# \| 📅 2026-03-16                                                                                                                                                                                 | [Elmish.WPF](https://github.com/elmish/Elmish.WPF) ⭐ 463 \| 🐛 61 \| 🌐 F# \| 📅 2024-10-01                                                                                                                                                                                                             |

<!--lint enable double-link -->

## Actor Frameworks

* [Orleans](https://github.com/dotnet/orleans) ⭐ 10,739 | 🐛 715 | 🌐 C# | 📅 2026-03-11 - Distributed virtual actor model.
...
* [Xake](https://github.com/OlegZee/Xake) ⭐ 5 | 🐛 1 | 🌐 F# | 📅 2026-03-15 - Another Make utility implementation on F#, fully declarative with no-brain parallelism, inspired by Shake.
...
* [Myriad](https://github.com/MoiraeSoftware/myriad) ⭐ 376 | 🐛 13 | 🌐 F# | 📅 2026-03-15 - A pre-compilation code generator.
...
* [Fable](https://github.com/fable-compiler/Fable) ⭐ 3,066 | 🐛 234 | 🌐 F# | 📅 2026-03-16 - F# to JavaScript compiler.
...
* [FSharp.Control.AsyncSeq](https://github.com/fsprojects/FSharp.Control.AsyncSeq) ⭐ 172 | 🐛 5 | 🌐 F# | 📅 2026-03-16 - Asynchronous sequence support, integration with `IAsyncEnumerable`.
...
* [Math.NET Numerics](https://github.com/mathnet/mathnet-numerics) ⭐ 3,727 | 🐛 326 | 🌐 C# | 📅 2025-03-03 - Methods and algorithms for numerical computations in science, engineering and every day use. F# specific bindings available.
...
* [Deedle](https://github.com/BlueMountainCapital/Deedle) ⭐ 984 | 🐛 65 | 🌐 F# | 📅 2026-03-16 - Exploratory data library for .NET.
...
* [Fantomas](https://github.com/fsprojects/fantomas) ⭐ 820 | 🐛 110 | 🌐 F# | 📅 2026-03-16 - F# code formatter.
...
* [FSharpFar](https://github.com/nightroman/FarNet) ⭐ 146 | 🐛 1 | 🌐 C# | 📅 2026-02-08 - F# support for Far Manager.
...
* [Npgsql.FSharp](https://github.com/Zaid-Ajaj/Npgsql.FSharp) ⭐ 338 | 🐛 16 | 🌐 F# | 📅 2026-02-28 - Thin F# wrapper around [Npgsql](https://github.com/npgsql/npgsql) ⭐ 3,662 | 🐛 214 | 🌐 C# | 📅 2026-03-15, the PostgreSQL database driver.
...
* [SqlHydra](https://github.com/JordanMarr/SqlHydra) ⭐ 259 | 🐛 6 | 🌐 F# | 📅 2026-03-15 - Suite of NuGet packages for working with databases in F# including query expressions and code generation tools (for generating strongly typed F# DTO record types based on your database tables). Supports MySQL, PostgreSQL, Oracle, SQL Server, and SQLite.
...
* [LiteDB.FSharp](https://github.com/Zaid-Ajaj/LiteDB.FSharp) ⭐ 184 | 🐛 8 | 🌐 F# | 📅 2022-12-08 - F# Support for [LiteDB](https://github.com/mbdavid/LiteDB) ⭐ 9,359 | 🐛 743 | 🌐 C# | 📅 2026-03-13, an embedded single file database for .NET.
...
* [Nu Game Engine](https://github.com/bryanedds/Nu) ⭐ 1,318 | 🐛 189 | 🌐 F# | 📅 2026-03-15 - Cross-platform F# 2D game engine built in the functional style. Uses SDL2 and Farseer Physics.
...
* [Avalonia.FuncUI](https://github.com/fsprojects/Avalonia.FuncUI) ⭐ 1,195 | 🐛 16 | 🌐 F# | 📅 2026-03-15 - Develop cross-platform MVU GUI Applications using F# and Avalonia.
...
* [NBomber](https://github.com/PragmaticFlow/NBomber) ⭐ 2,218 | 🐛 148 | 🌐 CSS | 📅 2026-03-10 - Simple load testing framework for Pull and Push scenarios.
...
* [FSharp.Data](https://github.com/fsharp/FSharp.Data) ⭐ 868 | 🐛 5 | 🌐 F# | 📅 2026-03-16 - Data science library that contains type providers for CSV, HTML, JSON, XML, and WorldBank data.
...
* [SwaggerProvider](https://github.com/fsprojects/SwaggerProvider) ⭐ 271 | 🐛 27 | 🌐 F# | 📅 2026-03-15 - Generative type provider for Swagger.
* [R Type Provider](https://github.com/BlueMountainCapital/FSharpRProvider) ⭐ 239 | 🐛 39 | 🌐 F# | 📅 2023-04-11 - Type provider to interop with R.
* [FSharp.Data.SqlClient](https://github.com/fsprojects/FSharp.Data.SqlClient) ⭐ 205 | 🐛 96 | 🌐 F# | 📅 2026-03-16 - F# type provider for statically typed access to T-SQL command parameters and result set.
...
* [FSharp.TypeProviders.StarterPack](https://github.com/fsprojects/FSharp.TypeProviders.StarterPack) ⭐ 303 | 🐛 12 | 🌐 F# | 📅 2026-03-15 - The ProvidedTypes SDK for creating F# type providers.
...
* [SharpVG](https://github.com/ChrisNikkel/SharpVG) ⭐ 80 | 🐛 13 | 🌐 F# | 📅 2026-03-15 - Create SVG vector graphics in F#.

## Web Frameworks

<!--lint disable double-link -->

* [Giraffe](https://github.com/giraffe-fsharp/Giraffe) ⭐ 2,230 | 🐛 44 | 🌐 F# | 📅 2026-03-15 - Native functional ASP.NET Core web framework for F# developers.
...
* [WebSharper](https://github.com/intellifactory/websharper) ⭐ 629 | 🐛 275 | 🌐 F# | 📅 2026-03-15 - F#-based web programming platform including a compiler from F# code to JavaScript.
...
* [Awesome .NET!](https://github.com/quozd/awesome-dotnet) ⭐ 21,175 | 🐛 47 | 📅 2025-09-16 - Collection of awesome .NET libraries, tools, frameworks and software.
