...
* [F# main repository](https://github.com/dotnet/fsharp) ⭐ 4,270 | 🐛 1,289 | 🌐 F# | 📅 2026-04-09
...
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [ASP.NET Core Blazor](https://github.com/dotnet/aspnetcore/tree/main/src/Components) ⭐ 37,817 \| 🐛 3,859 \| 🌐 C# \| 📅 2026-04-09                                                                                                                                | [Bolero](https://github.com/fsbolero/Bolero) ⭐ 1,128 \| 🐛 73 \| 🌐 F# \| 📅 2025-10-26                                                                                                                                                                                                                 |
| [ASP.NET Core](https://github.com/dotnet/aspnetcore) ⭐ 37,817 \| 🐛 3,859 \| 🌐 C# \| 📅 2026-04-09                                                                                                                                                                | [Giraffe](https://github.com/giraffe-fsharp/Giraffe) ⭐ 2,235 \| 🐛 50 \| 🌐 F# \| 📅 2026-03-16 (+ optionally [Saturn](https://github.com/SaturnFramework/Saturn) ⭐ 724 \| 🐛 55 \| 🌐 F# \| 📅 2024-07-31)<br/>[Oxpecker](https://github.com/Lanayx/Oxpecker) ⭐ 404 \| 🐛 10 \| 🌐 F# \| 📅 2026-04-08 |
| [Avalonia](https://github.com/AvaloniaUI/Avalonia) ⭐ 30,517 \| 🐛 1,910 \| 🌐 C# \| 📅 2026-04-08                                                                                                                                                                  | [Avalonia.FuncUI](https://github.com/fsprojects/Avalonia.FuncUI) ⭐ 1,211 \| 🐛 19 \| 🌐 F# \| 📅 2026-04-08                                                                                                                                                                                             |
| [MAUI](https://github.com/dotnet/maui) ⭐ 23,212 \| 🐛 4,047 \| 🌐 C# \| 📅 2026-04-09/[Xamarin.Forms](https://github.com/xamarin/Xamarin.Forms) ⚠️ Archived                                                                                                        | [Fabulous](https://github.com/fabulous-dev/Fabulous) ⭐ 1,256 \| 🐛 13 \| 🌐 F# \| 📅 2025-11-14                                                                                                                                                                                                         |
| [MSTest](https://github.com/microsoft/testfx) ⭐ 999 \| 🐛 206 \| 🌐 C# \| 📅 2026-04-09/[NUnit](https://github.com/nunit/nunit) ⭐ 2,618 \| 🐛 261 \| 🌐 C# \| 📅 2026-04-08/[xUnit.net](https://github.com/xunit/xunit) ⭐ 4,555 \| 🐛 63 \| 🌐 C# \| 📅 2026-04-08 | [FsUnit](https://github.com/fsprojects/FsUnit) ⭐ 443 \| 🐛 6 \| 🌐 F# \| 📅 2025-07-11                                                                                                                                                                                                                  |
| [System.Text.Json](https://github.com/dotnet/runtime/tree/main/src/libraries/System.Text.Json) ⭐ 17,771 \| 🐛 8,248 \| 🌐 C# \| 📅 2026-04-09                                                                                                                      | [FSharp.SystemTextJson](https://github.com/Tarmil/FSharp.SystemTextJson) ⭐ 365 \| 🐛 42 \| 🌐 F# \| 📅 2026-03-04                                                                                                                                                                                       |
| [WPF](https://github.com/dotnet/wpf) ⭐ 7,610 \| 🐛 1,628 \| 🌐 C# \| 📅 2026-04-09                                                                                                                                                                                 | [Elmish.WPF](https://github.com/elmish/Elmish.WPF) ⭐ 463 \| 🐛 61 \| 🌐 F# \| 📅 2024-10-01                                                                                                                                                                                                             |

<!--lint enable double-link -->

## Actor Frameworks

* [Orleans](https://github.com/dotnet/orleans) ⭐ 10,750 | 🐛 709 | 🌐 C# | 📅 2026-04-08 - Distributed virtual actor model.
...
* [Proto.actor](https://github.com/AsynkronIT/protoactor-dotnet) ⭐ 1,882 | 🐛 21 | 🌐 C# | 📅 2026-03-13 - Cross-platform actor framework for .NET, Go, Java and Kotlin.
...
* [Akkling](https://github.com/Horusiath/Akkling) ⭐ 232 | 🐛 26 | 🌐 F# | 📅 2026-04-08 - F# typed API for Akka.NET.
...
* [Fable](https://github.com/fable-compiler/Fable) ⭐ 3,069 | 🐛 217 | 🌐 F# | 📅 2026-04-09 - F# to JavaScript compiler.
...
* [FSharp.Control.AsyncSeq](https://github.com/fsprojects/FSharp.Control.AsyncSeq) ⭐ 173 | 🐛 3 | 🌐 F# | 📅 2026-04-09 - Asynchronous sequence support, integration with `IAsyncEnumerable`.
...
* [Fantomas](https://github.com/fsprojects/fantomas) ⭐ 824 | 🐛 85 | 🌐 F# | 📅 2026-04-09 - F# code formatter.
...
* [FsToolkit.ErrorHandling](https://github.com/demystifyfp/FsToolkit.ErrorHandling) ⭐ 542 | 🐛 6 | 🌐 F# | 📅 2026-04-08 - Clear, simple and powerful error handling with railway-oriented programming. Inspired by Chessie.
...
* [Npgsql.FSharp](https://github.com/Zaid-Ajaj/Npgsql.FSharp) ⭐ 339 | 🐛 16 | 🌐 F# | 📅 2026-02-28 - Thin F# wrapper around [Npgsql](https://github.com/npgsql/npgsql) ⭐ 3,672 | 🐛 213 | 🌐 C# | 📅 2026-04-08, the PostgreSQL database driver.
...
* [LiteDB.FSharp](https://github.com/Zaid-Ajaj/LiteDB.FSharp) ⭐ 184 | 🐛 8 | 🌐 F# | 📅 2022-12-08 - F# Support for [LiteDB](https://github.com/mbdavid/LiteDB) ⭐ 9,375 | 🐛 745 | 🌐 C# | 📅 2026-03-13, an embedded single file database for .NET.
...
* [Nu Game Engine](https://github.com/bryanedds/Nu) ⭐ 1,320 | 🐛 196 | 🌐 F# | 📅 2026-04-08 - Cross-platform F# 2D game engine built in the functional style. Uses SDL2 and Farseer Physics.
...
* [Avalonia.FuncUI](https://github.com/fsprojects/Avalonia.FuncUI) ⭐ 1,211 | 🐛 19 | 🌐 F# | 📅 2026-04-08 - Develop cross-platform MVU GUI Applications using F# and Avalonia.
...
* [Paket](https://github.com/fsprojects/Paket) ⭐ 2,087 | 🐛 782 | 🌐 F# | 📅 2026-01-20 - Dependency manager for .NET with support for NuGet packages and Git repositories.
...
* [NBomber](https://github.com/PragmaticFlow/NBomber) ⭐ 2,215 | 🐛 152 | 🌐 CSS | 📅 2026-03-23 - Simple load testing framework for Pull and Push scenarios.
...
* [FSharp.Data](https://github.com/fsharp/FSharp.Data) ⭐ 869 | 🐛 4 | 🌐 F# | 📅 2026-04-08 - Data science library that contains type providers for CSV, HTML, JSON, XML, and WorldBank data.
...
* [SwaggerProvider](https://github.com/fsprojects/SwaggerProvider) ⭐ 274 | 🐛 19 | 🌐 F# | 📅 2026-04-08 - Generative type provider for Swagger.
...
* [FSharp.TypeProviders.StarterPack](https://github.com/fsprojects/FSharp.TypeProviders.StarterPack) ⭐ 302 | 🐛 6 | 🌐 F# | 📅 2026-04-09 - The ProvidedTypes SDK for creating F# type providers.

## Visualization

* [Plotly.NET](https://github.com/plotly/Plotly.NET) ⭐ 845 | 🐛 46 | 🌐 F# | 📅 2026-04-02 - A Plotly-based general purpose plotting library for F#.
...
* [GG.Net](https://github.com/pablofrommars/GGNet) ⭐ 86 | 🐛 2 | 🌐 C# | 📅 2026-03-16 - Visualization library for data scientists.
...
* [Giraffe](https://github.com/giraffe-fsharp/Giraffe) ⭐ 2,235 | 🐛 50 | 🌐 F# | 📅 2026-03-16 - Native functional ASP.NET Core web framework for F# developers.
...
* [WebSharper](https://github.com/intellifactory/websharper) ⭐ 629 | 🐛 271 | 🌐 F# | 📅 2026-04-08 - F#-based web programming platform including a compiler from F# code to JavaScript.
* [Feliz](https://github.com/Zaid-Ajaj/Feliz) ⭐ 601 | 🐛 2 | 🌐 F# | 📅 2026-03-21 - A fresh retake of the React API in Fable and a collection of high-quality components to build React applications in F#.
...
* [Awesome .NET!](https://github.com/quozd/awesome-dotnet) ⭐ 21,236 | 🐛 57 | 📅 2026-03-26 - Collection of awesome .NET libraries, tools, frameworks and software.
