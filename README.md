...
* [F# main repository](https://github.com/dotnet/fsharp) ⭐ 4,270 | 🐛 1,290 | 🌐 F# | 📅 2026-03-27
...
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [ASP.NET Core Blazor](https://github.com/dotnet/aspnetcore/tree/main/src/Components) ⭐ 37,794 \| 🐛 3,831 \| 🌐 C# \| 📅 2026-03-26                                                                                                                                | [Bolero](https://github.com/fsbolero/Bolero) ⭐ 1,126 \| 🐛 73 \| 🌐 F# \| 📅 2025-10-26                                                                                                                                                                                                                 |
| [ASP.NET Core](https://github.com/dotnet/aspnetcore) ⭐ 37,794 \| 🐛 3,831 \| 🌐 C# \| 📅 2026-03-26                                                                                                                                                                | [Giraffe](https://github.com/giraffe-fsharp/Giraffe) ⭐ 2,233 \| 🐛 49 \| 🌐 F# \| 📅 2026-03-16 (+ optionally [Saturn](https://github.com/SaturnFramework/Saturn) ⭐ 724 \| 🐛 55 \| 🌐 F# \| 📅 2024-07-31)<br/>[Oxpecker](https://github.com/Lanayx/Oxpecker) ⭐ 404 \| 🐛 10 \| 🌐 F# \| 📅 2026-03-20 |
| [Avalonia](https://github.com/AvaloniaUI/Avalonia) ⭐ 30,389 \| 🐛 1,912 \| 🌐 C# \| 📅 2026-03-26                                                                                                                                                                  | [Avalonia.FuncUI](https://github.com/fsprojects/Avalonia.FuncUI) ⭐ 1,202 \| 🐛 18 \| 🌐 F# \| 📅 2026-03-15                                                                                                                                                                                             |
| [MAUI](https://github.com/dotnet/maui) ⭐ 23,216 \| 🐛 4,229 \| 🌐 C# \| 📅 2026-03-27/[Xamarin.Forms](https://github.com/xamarin/Xamarin.Forms) ⚠️ Archived                                                                                                        | [Fabulous](https://github.com/fabulous-dev/Fabulous) ⭐ 1,257 \| 🐛 13 \| 🌐 F# \| 📅 2025-11-14                                                                                                                                                                                                         |
| [MSTest](https://github.com/microsoft/testfx) ⭐ 994 \| 🐛 219 \| 🌐 C# \| 📅 2026-03-27/[NUnit](https://github.com/nunit/nunit) ⭐ 2,617 \| 🐛 252 \| 🌐 C# \| 📅 2026-03-26/[xUnit.net](https://github.com/xunit/xunit) ⭐ 4,548 \| 🐛 63 \| 🌐 C# \| 📅 2026-03-26 | [FsUnit](https://github.com/fsprojects/FsUnit) ⭐ 443 \| 🐛 6 \| 🌐 F# \| 📅 2025-07-11                                                                                                                                                                                                                  |
| [System.Text.Json](https://github.com/dotnet/runtime/tree/main/src/libraries/System.Text.Json) ⭐ 17,753 \| 🐛 8,268 \| 🌐 C# \| 📅 2026-03-27                                                                                                                      | [FSharp.SystemTextJson](https://github.com/Tarmil/FSharp.SystemTextJson) ⭐ 365 \| 🐛 42 \| 🌐 F# \| 📅 2026-03-04                                                                                                                                                                                       |
| [WPF](https://github.com/dotnet/wpf) ⭐ 7,601 \| 🐛 1,623 \| 🌐 C# \| 📅 2026-03-27                                                                                                                                                                                 | [Elmish.WPF](https://github.com/elmish/Elmish.WPF) ⭐ 462 \| 🐛 61 \| 🌐 F# \| 📅 2024-10-01                                                                                                                                                                                                             |

<!--lint enable double-link -->

## Actor Frameworks

* [Orleans](https://github.com/dotnet/orleans) ⭐ 10,746 | 🐛 719 | 🌐 C# | 📅 2026-03-26 - Distributed virtual actor model.
* [Akka.NET](https://github.com/akkadotnet/akka.net) ⭐ 5,030 | 🐛 420 | 🌐 C# | 📅 2026-03-26 - Community-driven port of the popular Java/Scala framework Akka to .NET.
...
* [Myriad](https://github.com/MoiraeSoftware/myriad) ⭐ 377 | 🐛 30 | 🌐 F# | 📅 2026-03-25 - A pre-compilation code generator.
...
* [Fable](https://github.com/fable-compiler/Fable) ⭐ 3,067 | 🐛 219 | 🌐 F# | 📅 2026-03-27 - F# to JavaScript compiler.
...
* [FSharp.Control.AsyncSeq](https://github.com/fsprojects/FSharp.Control.AsyncSeq) ⭐ 173 | 🐛 3 | 🌐 F# | 📅 2026-03-26 - Asynchronous sequence support, integration with `IAsyncEnumerable`.
...
* [Npgsql.FSharp](https://github.com/Zaid-Ajaj/Npgsql.FSharp) ⭐ 339 | 🐛 16 | 🌐 F# | 📅 2026-02-28 - Thin F# wrapper around [Npgsql](https://github.com/npgsql/npgsql) ⭐ 3,669 | 🐛 212 | 🌐 C# | 📅 2026-03-25, the PostgreSQL database driver.
...
* [SqlHydra](https://github.com/JordanMarr/SqlHydra) ⭐ 261 | 🐛 7 | 🌐 F# | 📅 2026-03-25 - Suite of NuGet packages for working with databases in F# including query expressions and code generation tools (for generating strongly typed F# DTO record types based on your database tables). Supports MySQL, PostgreSQL, Oracle, SQL Server, and SQLite.
...
* [LiteDB.FSharp](https://github.com/Zaid-Ajaj/LiteDB.FSharp) ⭐ 184 | 🐛 8 | 🌐 F# | 📅 2022-12-08 - F# Support for [LiteDB](https://github.com/mbdavid/LiteDB) ⭐ 9,369 | 🐛 743 | 🌐 C# | 📅 2026-03-13, an embedded single file database for .NET.
...
* [Nu Game Engine](https://github.com/bryanedds/Nu) ⭐ 1,320 | 🐛 196 | 🌐 F# | 📅 2026-03-26 - Cross-platform F# 2D game engine built in the functional style. Uses SDL2 and Farseer Physics.
...
* [Avalonia.FuncUI](https://github.com/fsprojects/Avalonia.FuncUI) ⭐ 1,202 | 🐛 18 | 🌐 F# | 📅 2026-03-15 - Develop cross-platform MVU GUI Applications using F# and Avalonia.
...
* [FsHttp](https://github.com/ronaldschlenker/FsHttp) ⭐ 498 | 🐛 30 | 🌐 F# | 📅 2026-03-10 - A convenient library for consuming HTTP/REST endpoints via F#.
* [Http.fs](https://github.com/haf/Http.fs) ⭐ 318 | 🐛 19 | 🌐 HTML | 📅 2023-08-02 - A simple, functional HTTP client library for F#.
* [Oryx](https://github.com/cognitedata/oryx) ⭐ 211 | 🐛 8 | 🌐 F# | 📅 2026-03-26 - A high performance .NET cross-platform functional HTTP request handler library for writing HTTP clients and orchestrating web requests.
...
* [FsCodec](https://github.com/jet/FsCodec) ⭐ 82 | 🐛 8 | 🌐 F# | 📅 2026-03-26 - F# Event-Union Contract Encoding with versioning tolerant converters.
...
* [Expecto](https://github.com/haf/expecto) ⭐ 726 | 🐛 62 | 🌐 F# | 📅 2026-03-19 - Smooth testing framework for F# with tests-as-values and parallelism by default.
...
* [FsUnit](https://github.com/fsprojects/FsUnit) ⭐ 443 | 🐛 6 | 🌐 F# | 📅 2025-07-11 - Makes unit-testing with F# more enjoyable. It adds a special syntax to your favorite .NET testing framework.
...
* [FSharp.Data](https://github.com/fsharp/FSharp.Data) ⭐ 867 | 🐛 5 | 🌐 F# | 📅 2026-03-26 - Data science library that contains type providers for CSV, HTML, JSON, XML, and WorldBank data.
* [Rezoom.SQL](https://github.com/rspeele/Rezoom.SQL) ⭐ 677 | 🐛 30 | 🌐 F# | 📅 2020-07-13 - Statically typed SQL for F#.
...
* [SwaggerProvider](https://github.com/fsprojects/SwaggerProvider) ⭐ 273 | 🐛 21 | 🌐 F# | 📅 2026-03-26 - Generative type provider for Swagger.
...
* [FSharp.TypeProviders.StarterPack](https://github.com/fsprojects/FSharp.TypeProviders.StarterPack) ⭐ 302 | 🐛 6 | 🌐 F# | 📅 2026-03-26 - The ProvidedTypes SDK for creating F# type providers.
...
* [SharpVG](https://github.com/ChrisNikkel/SharpVG) ⭐ 79 | 🐛 14 | 🌐 F# | 📅 2026-03-26 - Create SVG vector graphics in F#.
...
* [WebSharper](https://github.com/intellifactory/websharper) ⭐ 630 | 🐛 277 | 🌐 F# | 📅 2026-03-26 - F#-based web programming platform including a compiler from F# code to JavaScript.
...
* [Awesome .NET!](https://github.com/quozd/awesome-dotnet) ⭐ 21,198 | 🐛 52 | 📅 2026-03-26 - Collection of awesome .NET libraries, tools, frameworks and software.
