...
* [F# main repository](https://github.com/dotnet/fsharp) ⭐ 4,284 | 🐛 1,247 | 🌐 F# | 📅 2026-04-29
...
| -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| [ASP.NET Core Blazor](https://github.com/dotnet/aspnetcore/tree/main/src/Components) ⭐ 37,872 \| 🐛 3,912 \| 🌐 C# \| 📅 2026-04-29                                                                                                                                  | [Bolero](https://github.com/fsbolero/Bolero) ⭐ 1,125 \| 🐛 73 \| 🌐 F# \| 📅 2025-10-26                                                                                                                                                                                                                |
| [ASP.NET Core](https://github.com/dotnet/aspnetcore) ⭐ 37,872 \| 🐛 3,912 \| 🌐 C# \| 📅 2026-04-29                                                                                                                                                                  | [Giraffe](https://github.com/giraffe-fsharp/Giraffe) ⭐ 2,236 \| 🐛 47 \| 🌐 F# \| 📅 2026-04-27 (+ optionally [Saturn](https://github.com/SaturnFramework/Saturn) ⭐ 725 \| 🐛 55 \| 🌐 F# \| 📅 2024-07-31)<br/>[Oxpecker](https://github.com/Lanayx/Oxpecker) ⭐ 410 \| 🐛 9 \| 🌐 F# \| 📅 2026-04-28 |
| [Avalonia](https://github.com/AvaloniaUI/Avalonia) ⭐ 30,664 \| 🐛 1,866 \| 🌐 C# \| 📅 2026-04-29                                                                                                                                                                    | [Avalonia.FuncUI](https://github.com/fsprojects/Avalonia.FuncUI) ⭐ 1,223 \| 🐛 19 \| 🌐 F# \| 📅 2026-04-27                                                                                                                                                                                            |
| [MAUI](https://github.com/dotnet/maui) ⭐ 23,240 \| 🐛 4,072 \| 🌐 C# \| 📅 2026-04-29/[Xamarin.Forms](https://github.com/xamarin/Xamarin.Forms) ⚠️ Archived                                                                                                          | [Fabulous](https://github.com/fabulous-dev/Fabulous) ⭐ 1,256 \| 🐛 13 \| 🌐 F# \| 📅 2025-11-14                                                                                                                                                                                                        |
| [MSTest](https://github.com/microsoft/testfx) ⭐ 1,005 \| 🐛 235 \| 🌐 C# \| 📅 2026-04-29/[NUnit](https://github.com/nunit/nunit) ⭐ 2,620 \| 🐛 260 \| 🌐 C# \| 📅 2026-04-24/[xUnit.net](https://github.com/xunit/xunit) ⭐ 4,566 \| 🐛 52 \| 🌐 C# \| 📅 2026-04-28 | [FsUnit](https://github.com/fsprojects/FsUnit) ⭐ 446 \| 🐛 6 \| 🌐 F# \| 📅 2025-07-11                                                                                                                                                                                                                 |
| [System.Text.Json](https://github.com/dotnet/runtime/tree/main/src/libraries/System.Text.Json) ⭐ 17,847 \| 🐛 8,166 \| 🌐 C# \| 📅 2026-04-29                                                                                                                        | [FSharp.SystemTextJson](https://github.com/Tarmil/FSharp.SystemTextJson) ⭐ 367 \| 🐛 43 \| 🌐 F# \| 📅 2026-04-21                                                                                                                                                                                      |
| [WPF](https://github.com/dotnet/wpf) ⭐ 7,625 \| 🐛 1,635 \| 🌐 C# \| 📅 2026-04-29                                                                                                                                                                                   | [Elmish.WPF](https://github.com/elmish/Elmish.WPF) ⭐ 463 \| 🐛 61 \| 🌐 F# \| 📅 2024-10-01                                                                                                                                                                                                            |

<!--lint enable double-link -->

## Actor Frameworks

* [Orleans](https://github.com/dotnet/orleans) ⭐ 10,761 | 🐛 718 | 🌐 C# | 📅 2026-04-29 - Distributed virtual actor model.
* [Akka.NET](https://github.com/akkadotnet/akka.net) ⭐ 5,045 | 🐛 412 | 🌐 C# | 📅 2026-04-26 - Community-driven port of the popular Java/Scala framework Akka to .NET.
...
* [Fable](https://github.com/fable-compiler/Fable) ⭐ 3,074 | 🐛 224 | 🌐 F# | 📅 2026-04-28 - F# to JavaScript compiler.
...
* [FSharp.Control.AsyncSeq](https://github.com/fsprojects/FSharp.Control.AsyncSeq) ⭐ 173 | 🐛 8 | 🌐 F# | 📅 2026-04-29 - Asynchronous sequence support, integration with `IAsyncEnumerable`.
...
* [FIO](https://github.com/iyyel/fio) ⭐ 84 | 🐛 0 | 🌐 F# | 📅 2026-04-27 - A type-safe, highly concurrent and asynchronous library for F# based on pure functional programming.
...
* [docopt.fs](https://github.com/docopt/docopt.fs/) ⭐ 36 | 🐛 0 | 🌐 F# | 📅 2020-01-15 - Command line arguments parser, F# port of [docopt](https://github.com/docopt/docopt) ⭐ 8,012 | 🐛 266 | 🌐 Python | 📅 2025-06-23.
...
* [Fantomas](https://github.com/fsprojects/fantomas) ⭐ 826 | 🐛 80 | 🌐 F# | 📅 2026-04-27 - F# code formatter.
...
* [FSharpLu](https://github.com/Microsoft/fsharplu) ⭐ 373 | 🐛 9 | 🌐 F# | 📅 2024-06-11 - Lightweight utilities for string manipulations, logging, collection data structures, file operations, text processing, security, async, parsing, diagnostics, configuration files and Json serialization.
...
* [SqlHydra](https://github.com/JordanMarr/SqlHydra) ⭐ 263 | 🐛 7 | 🌐 F# | 📅 2026-04-17 - Suite of NuGet packages for working with databases in F# including query expressions and code generation tools (for generating strongly typed F# DTO record types based on your database tables). Supports MySQL, PostgreSQL, Oracle, SQL Server, and SQLite.
...
* [LiteDB.FSharp](https://github.com/Zaid-Ajaj/LiteDB.FSharp) ⭐ 185 | 🐛 8 | 🌐 F# | 📅 2022-12-08 - F# Support for [LiteDB](https://github.com/mbdavid/LiteDB) ⭐ 9,386 | 🐛 745 | 🌐 C# | 📅 2026-03-13, an embedded single file database for .NET.
...
* [Nu Game Engine](https://github.com/bryanedds/Nu) ⭐ 1,320 | 🐛 197 | 🌐 F# | 📅 2026-04-28 - Cross-platform F# 2D game engine built in the functional style. Uses SDL2 and Farseer Physics.
...
* [NBomber](https://github.com/PragmaticFlow/NBomber) ⭐ 2,221 | 🐛 161 | 🌐 CSS | 📅 2026-04-20 - Simple load testing framework for Pull and Push scenarios.
* [FsCheck](https://github.com/fscheck/FsCheck) ⭐ 1,216 | 🐛 22 | 🌐 F# | 📅 2026-04-26 - Random testing for .NET.
* [Expecto](https://github.com/haf/expecto) ⭐ 734 | 🐛 64 | 🌐 F# | 📅 2026-03-19 - Smooth testing framework for F# with tests-as-values and parallelism by default.
...
* [FSharp.Data](https://github.com/fsharp/FSharp.Data) ⭐ 870 | 🐛 17 | 🌐 F# | 📅 2026-04-29 - Data science library that contains type providers for CSV, HTML, JSON, XML, and WorldBank data.
...
* [SwaggerProvider](https://github.com/fsprojects/SwaggerProvider) ⭐ 276 | 🐛 4 | 🌐 F# | 📅 2026-04-28 - Generative type provider for Swagger.
...
* [FSharp.TypeProviders.StarterPack](https://github.com/fsprojects/FSharp.TypeProviders.StarterPack) ⭐ 304 | 🐛 8 | 🌐 F# | 📅 2026-04-29 - The ProvidedTypes SDK for creating F# type providers.
...
* [WebSharper](https://github.com/intellifactory/websharper) ⭐ 629 | 🐛 276 | 🌐 F# | 📅 2026-04-28 - F#-based web programming platform including a compiler from F# code to JavaScript.
* [Feliz](https://github.com/Zaid-Ajaj/Feliz) ⭐ 602 | 🐛 3 | 🌐 F# | 📅 2026-04-20 - A fresh retake of the React API in Fable and a collection of high-quality components to build React applications in F#.
* [Oxpecker](https://github.com/Lanayx/Oxpecker) ⭐ 410 | 🐛 9 | 🌐 F# | 📅 2026-04-28 - ASP.NET Core based F# framework + supporting tools (ViewEngine, Htmx, OpenApi).
...
* [Awesome .NET!](https://github.com/quozd/awesome-dotnet) ⭐ 21,304 | 🐛 63 | 📅 2026-03-26 - Collection of awesome .NET libraries, tools, frameworks and software.
