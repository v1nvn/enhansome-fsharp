...
* [F# main repository](https://github.com/dotnet/fsharp) ⭐ 4,270 | 🐛 1,283 | 🌐 F# | 📅 2026-04-04
...
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [ASP.NET Core Blazor](https://github.com/dotnet/aspnetcore/tree/main/src/Components) ⭐ 37,810 \| 🐛 3,861 \| 🌐 C# \| 📅 2026-04-05                                                                                                                                | [Bolero](https://github.com/fsbolero/Bolero) ⭐ 1,128 \| 🐛 73 \| 🌐 F# \| 📅 2025-10-26                                                                                                                                                                                                                 |
| [ASP.NET Core](https://github.com/dotnet/aspnetcore) ⭐ 37,810 \| 🐛 3,861 \| 🌐 C# \| 📅 2026-04-05                                                                                                                                                                | [Giraffe](https://github.com/giraffe-fsharp/Giraffe) ⭐ 2,234 \| 🐛 49 \| 🌐 F# \| 📅 2026-03-16 (+ optionally [Saturn](https://github.com/SaturnFramework/Saturn) ⭐ 724 \| 🐛 55 \| 🌐 F# \| 📅 2024-07-31)<br/>[Oxpecker](https://github.com/Lanayx/Oxpecker) ⭐ 404 \| 🐛 10 \| 🌐 F# \| 📅 2026-04-03 |
| [Avalonia](https://github.com/AvaloniaUI/Avalonia) ⭐ 30,473 \| 🐛 1,919 \| 🌐 C# \| 📅 2026-04-03                                                                                                                                                                  | [Avalonia.FuncUI](https://github.com/fsprojects/Avalonia.FuncUI) ⭐ 1,205 \| 🐛 18 \| 🌐 F# \| 📅 2026-04-01                                                                                                                                                                                             |
| [MAUI](https://github.com/dotnet/maui) ⭐ 23,215 \| 🐛 4,197 \| 🌐 C# \| 📅 2026-04-05/[Xamarin.Forms](https://github.com/xamarin/Xamarin.Forms) ⚠️ Archived                                                                                                        | [Fabulous](https://github.com/fabulous-dev/Fabulous) ⭐ 1,255 \| 🐛 13 \| 🌐 F# \| 📅 2025-11-14                                                                                                                                                                                                         |
| [MSTest](https://github.com/microsoft/testfx) ⭐ 999 \| 🐛 204 \| 🌐 C# \| 📅 2026-04-05/[NUnit](https://github.com/nunit/nunit) ⭐ 2,618 \| 🐛 262 \| 🌐 C# \| 📅 2026-04-04/[xUnit.net](https://github.com/xunit/xunit) ⭐ 4,555 \| 🐛 61 \| 🌐 C# \| 📅 2026-04-02 | [FsUnit](https://github.com/fsprojects/FsUnit) ⭐ 444 \| 🐛 6 \| 🌐 F# \| 📅 2025-07-11                                                                                                                                                                                                                  |
| [System.Text.Json](https://github.com/dotnet/runtime/tree/main/src/libraries/System.Text.Json) ⭐ 17,757 \| 🐛 8,241 \| 🌐 C# \| 📅 2026-04-05                                                                                                                      | [FSharp.SystemTextJson](https://github.com/Tarmil/FSharp.SystemTextJson) ⭐ 365 \| 🐛 42 \| 🌐 F# \| 📅 2026-03-04                                                                                                                                                                                       |
| [WPF](https://github.com/dotnet/wpf) ⭐ 7,604 \| 🐛 1,624 \| 🌐 C# \| 📅 2026-04-05                                                                                                                                                                                 | [Elmish.WPF](https://github.com/elmish/Elmish.WPF) ⭐ 462 \| 🐛 61 \| 🌐 F# \| 📅 2024-10-01                                                                                                                                                                                                             |

<!--lint enable double-link -->

## Actor Frameworks

* [Orleans](https://github.com/dotnet/orleans) ⭐ 10,749 | 🐛 709 | 🌐 C# | 📅 2026-04-04 - Distributed virtual actor model.
* [Akka.NET](https://github.com/akkadotnet/akka.net) ⭐ 5,034 | 🐛 420 | 🌐 C# | 📅 2026-03-31 - Community-driven port of the popular Java/Scala framework Akka to .NET.
...
* [Fable](https://github.com/fable-compiler/Fable) ⭐ 3,069 | 🐛 222 | 🌐 F# | 📅 2026-04-05 - F# to JavaScript compiler.
...
* [FSharp.Control.AsyncSeq](https://github.com/fsprojects/FSharp.Control.AsyncSeq) ⭐ 173 | 🐛 3 | 🌐 F# | 📅 2026-04-05 - Asynchronous sequence support, integration with `IAsyncEnumerable`.
...
* [m2cgen](https://github.com/BayesWitnesses/m2cgen) ⭐ 2,966 | 🐛 62 | 🌐 Python | 📅 2024-08-03 - A CLI tool to transpile trained classic ML models into a native F# code with zero dependencies.
* [Deedle](https://github.com/BlueMountainCapital/Deedle) ⭐ 996 | 🐛 3 | 🌐 F# | 📅 2026-04-04 - Exploratory data library for .NET.
...
* [Fantomas](https://github.com/fsprojects/fantomas) ⭐ 823 | 🐛 85 | 🌐 F# | 📅 2026-04-05 - F# code formatter.
...
* [Npgsql.FSharp](https://github.com/Zaid-Ajaj/Npgsql.FSharp) ⭐ 339 | 🐛 16 | 🌐 F# | 📅 2026-02-28 - Thin F# wrapper around [Npgsql](https://github.com/npgsql/npgsql) ⭐ 3,671 | 🐛 215 | 🌐 C# | 📅 2026-04-04, the PostgreSQL database driver.
...
* [SqlHydra](https://github.com/JordanMarr/SqlHydra) ⭐ 261 | 🐛 7 | 🌐 F# | 📅 2026-04-05 - Suite of NuGet packages for working with databases in F# including query expressions and code generation tools (for generating strongly typed F# DTO record types based on your database tables). Supports MySQL, PostgreSQL, Oracle, SQL Server, and SQLite.
...
* [Nu Game Engine](https://github.com/bryanedds/Nu) ⭐ 1,321 | 🐛 197 | 🌐 F# | 📅 2026-04-05 - Cross-platform F# 2D game engine built in the functional style. Uses SDL2 and Farseer Physics.
...
* [SkunkHTML](https://github.com/mg0x7BE/skunk-html) ⭐ 165 | 🐛 0 | 🌐 F# | 📅 2026-04-05 - Markdown blog with GitHub Pages.

## Testing

<!--lint disable double-link -->

* [NBomber](https://github.com/PragmaticFlow/NBomber) ⭐ 2,217 | 🐛 150 | 🌐 CSS | 📅 2026-03-23 - Simple load testing framework for Pull and Push scenarios.
* [FsCheck](https://github.com/fscheck/FsCheck) ⭐ 1,211 | 🐛 23 | 🌐 F# | 📅 2026-02-02 - Random testing for .NET.
* [Expecto](https://github.com/haf/expecto) ⭐ 728 | 🐛 63 | 🌐 F# | 📅 2026-03-19 - Smooth testing framework for F# with tests-as-values and parallelism by default.
...
* [FSharp.Data](https://github.com/fsharp/FSharp.Data) ⭐ 868 | 🐛 3 | 🌐 F# | 📅 2026-04-04 - Data science library that contains type providers for CSV, HTML, JSON, XML, and WorldBank data.
...
* [SwaggerProvider](https://github.com/fsprojects/SwaggerProvider) ⭐ 273 | 🐛 17 | 🌐 F# | 📅 2026-04-04 - Generative type provider for Swagger.
* [R Type Provider](https://github.com/BlueMountainCapital/FSharpRProvider) ⭐ 239 | 🐛 40 | 🌐 F# | 📅 2023-04-11 - Type provider to interop with R.
* [FSharp.Data.SqlClient](https://github.com/fsprojects/FSharp.Data.SqlClient) ⭐ 205 | 🐛 72 | 🌐 F# | 📅 2026-04-04 - F# type provider for statically typed access to T-SQL command parameters and result set.
...
* [FSharp.TypeProviders.StarterPack](https://github.com/fsprojects/FSharp.TypeProviders.StarterPack) ⭐ 302 | 🐛 6 | 🌐 F# | 📅 2026-04-05 - The ProvidedTypes SDK for creating F# type providers.
...
* [SharpVG](https://github.com/ChrisNikkel/SharpVG) ⭐ 79 | 🐛 13 | 🌐 F# | 📅 2026-04-05 - Create SVG vector graphics in F#.
...
* [Falco](https://github.com/pimbrouwers/Falco/) ⭐ 631 | 🐛 6 | 🌐 F# | 📅 2026-03-19 - A functional-first toolkit for building brilliant ASP.NET Core applications using F#.
...
* [Feliz](https://github.com/Zaid-Ajaj/Feliz) ⭐ 599 | 🐛 1 | 🌐 F# | 📅 2026-03-21 - A fresh retake of the React API in Fable and a collection of high-quality components to build React applications in F#.
...
* [Awesome .NET!](https://github.com/quozd/awesome-dotnet) ⭐ 21,225 | 🐛 56 | 📅 2026-03-26 - Collection of awesome .NET libraries, tools, frameworks and software.
