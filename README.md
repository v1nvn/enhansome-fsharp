...
* [F# main repository](https://github.com/dotnet/fsharp) ⭐ 4,271 | 🐛 1,310 | 🌐 F# | 📅 2026-03-17
...
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [ASP.NET Core Blazor](https://github.com/dotnet/aspnetcore/tree/main/src/Components) ⭐ 37,776 \| 🐛 3,799 \| 🌐 C# \| 📅 2026-03-17                                                                                                                                | [Bolero](https://github.com/fsbolero/Bolero) ⭐ 1,123 \| 🐛 73 \| 🌐 F# \| 📅 2025-10-26                                                                                                                                                                                                                 |
| [ASP.NET Core](https://github.com/dotnet/aspnetcore) ⭐ 37,776 \| 🐛 3,799 \| 🌐 C# \| 📅 2026-03-17                                                                                                                                                                | [Giraffe](https://github.com/giraffe-fsharp/Giraffe) ⭐ 2,230 \| 🐛 49 \| 🌐 F# \| 📅 2026-03-16 (+ optionally [Saturn](https://github.com/SaturnFramework/Saturn) ⭐ 725 \| 🐛 55 \| 🌐 F# \| 📅 2024-07-31)<br/>[Oxpecker](https://github.com/Lanayx/Oxpecker) ⭐ 403 \| 🐛 10 \| 🌐 F# \| 📅 2026-02-13 |
| [Avalonia](https://github.com/AvaloniaUI/Avalonia) ⭐ 30,261 \| 🐛 1,907 \| 🌐 C# \| 📅 2026-03-16                                                                                                                                                                  | [Avalonia.FuncUI](https://github.com/fsprojects/Avalonia.FuncUI) ⭐ 1,195 \| 🐛 16 \| 🌐 F# \| 📅 2026-03-15                                                                                                                                                                                             |
| [MAUI](https://github.com/dotnet/maui) ⭐ 23,212 \| 🐛 4,359 \| 🌐 C# \| 📅 2026-03-17/[Xamarin.Forms](https://github.com/xamarin/Xamarin.Forms) ⚠️ Archived                                                                                                        | [Fabulous](https://github.com/fabulous-dev/Fabulous) ⭐ 1,254 \| 🐛 13 \| 🌐 F# \| 📅 2025-11-14                                                                                                                                                                                                         |
| [MSTest](https://github.com/microsoft/testfx) ⭐ 994 \| 🐛 226 \| 🌐 C# \| 📅 2026-03-17/[NUnit](https://github.com/nunit/nunit) ⭐ 2,612 \| 🐛 251 \| 🌐 C# \| 📅 2026-03-15/[xUnit.net](https://github.com/xunit/xunit) ⭐ 4,543 \| 🐛 59 \| 🌐 C# \| 📅 2026-03-13 | [FsUnit](https://github.com/fsprojects/FsUnit) ⭐ 444 \| 🐛 6 \| 🌐 F# \| 📅 2025-07-11                                                                                                                                                                                                                  |
| [System.Text.Json](https://github.com/dotnet/runtime/tree/main/src/libraries/System.Text.Json) ⭐ 17,750 \| 🐛 8,280 \| 🌐 C# \| 📅 2026-03-17                                                                                                                      | [FSharp.SystemTextJson](https://github.com/Tarmil/FSharp.SystemTextJson) ⭐ 365 \| 🐛 42 \| 🌐 F# \| 📅 2026-03-04                                                                                                                                                                                       |
| [WPF](https://github.com/dotnet/wpf) ⭐ 7,595 \| 🐛 1,623 \| 🌐 C# \| 📅 2026-03-17                                                                                                                                                                                 | [Elmish.WPF](https://github.com/elmish/Elmish.WPF) ⭐ 463 \| 🐛 61 \| 🌐 F# \| 📅 2024-10-01                                                                                                                                                                                                             |
...
* [Akka.NET](https://github.com/akkadotnet/akka.net) ⭐ 5,034 | 🐛 422 | 🌐 C# | 📅 2026-03-16 - Community-driven port of the popular Java/Scala framework Akka to .NET.
...
* [Xake](https://github.com/OlegZee/Xake) ⭐ 5 | 🐛 0 | 🌐 F# | 📅 2026-03-16 - Another Make utility implementation on F#, fully declarative with no-brain parallelism, inspired by Shake.
...
* [Myriad](https://github.com/MoiraeSoftware/myriad) ⭐ 376 | 🐛 15 | 🌐 F# | 📅 2026-03-16 - A pre-compilation code generator.
...
* [Fable](https://github.com/fable-compiler/Fable) ⭐ 3,066 | 🐛 234 | 🌐 F# | 📅 2026-03-17 - F# to JavaScript compiler.
...
* [FSharp.Control.AsyncSeq](https://github.com/fsprojects/FSharp.Control.AsyncSeq) ⭐ 172 | 🐛 7 | 🌐 F# | 📅 2026-03-17 - Asynchronous sequence support, integration with `IAsyncEnumerable`.
...
* [Deedle](https://github.com/BlueMountainCapital/Deedle) ⭐ 984 | 🐛 62 | 🌐 F# | 📅 2026-03-17 - Exploratory data library for .NET.
...
* [Fantomas](https://github.com/fsprojects/fantomas) ⭐ 820 | 🐛 101 | 🌐 F# | 📅 2026-03-17 - F# code formatter.
...
* [FsToolkit.ErrorHandling](https://github.com/demystifyfp/FsToolkit.ErrorHandling) ⭐ 534 | 🐛 5 | 🌐 F# | 📅 2026-03-02 - Clear, simple and powerful error handling with railway-oriented programming. Inspired by Chessie.
...
* [Npgsql.FSharp](https://github.com/Zaid-Ajaj/Npgsql.FSharp) ⭐ 338 | 🐛 16 | 🌐 F# | 📅 2026-02-28 - Thin F# wrapper around [Npgsql](https://github.com/npgsql/npgsql) ⭐ 3,662 | 🐛 211 | 🌐 C# | 📅 2026-03-16, the PostgreSQL database driver.
...
* [LiteDB.FSharp](https://github.com/Zaid-Ajaj/LiteDB.FSharp) ⭐ 184 | 🐛 8 | 🌐 F# | 📅 2022-12-08 - F# Support for [LiteDB](https://github.com/mbdavid/LiteDB) ⭐ 9,360 | 🐛 743 | 🌐 C# | 📅 2026-03-13, an embedded single file database for .NET.
...
* [Nu Game Engine](https://github.com/bryanedds/Nu) ⭐ 1,319 | 🐛 189 | 🌐 F# | 📅 2026-03-17 - Cross-platform F# 2D game engine built in the functional style. Uses SDL2 and Farseer Physics.
...
* [FSharp.Data](https://github.com/fsharp/FSharp.Data) ⭐ 868 | 🐛 6 | 🌐 F# | 📅 2026-03-17 - Data science library that contains type providers for CSV, HTML, JSON, XML, and WorldBank data.
* [Rezoom.SQL](https://github.com/rspeele/Rezoom.SQL) ⭐ 678 | 🐛 30 | 🌐 F# | 📅 2020-07-13 - Statically typed SQL for F#.
* [SQLProvider](https://github.com/fsprojects/SQLProvider) ⭐ 622 | 🐛 123 | 🌐 F# | 📅 2025-11-16 - General F# SQL database erasing type provider, supporting LINQ queries, schema exploration, individuals, CRUD operations and much more besides.
* [SwaggerProvider](https://github.com/fsprojects/SwaggerProvider) ⭐ 271 | 🐛 28 | 🌐 F# | 📅 2026-03-16 - Generative type provider for Swagger.
* [R Type Provider](https://github.com/BlueMountainCapital/FSharpRProvider) ⭐ 239 | 🐛 39 | 🌐 F# | 📅 2023-04-11 - Type provider to interop with R.
* [FSharp.Data.SqlClient](https://github.com/fsprojects/FSharp.Data.SqlClient) ⭐ 205 | 🐛 69 | 🌐 F# | 📅 2026-03-16 - F# type provider for statically typed access to T-SQL command parameters and result set.
...
* [FSharp.TypeProviders.StarterPack](https://github.com/fsprojects/FSharp.TypeProviders.StarterPack) ⭐ 303 | 🐛 5 | 🌐 F# | 📅 2026-03-17 - The ProvidedTypes SDK for creating F# type providers.
...
* [Giraffe](https://github.com/giraffe-fsharp/Giraffe) ⭐ 2,230 | 🐛 49 | 🌐 F# | 📅 2026-03-16 - Native functional ASP.NET Core web framework for F# developers.
...
* [WebSharper](https://github.com/intellifactory/websharper) ⭐ 629 | 🐛 275 | 🌐 F# | 📅 2026-03-16 - F#-based web programming platform including a compiler from F# code to JavaScript.
...
* [Feliz](https://github.com/Zaid-Ajaj/Feliz) ⭐ 593 | 🐛 0 | 🌐 F# | 📅 2026-01-01 - A fresh retake of the React API in Fable and a collection of high-quality components to build React applications in F#.
...
* [Awesome .NET!](https://github.com/quozd/awesome-dotnet) ⭐ 21,176 | 🐛 46 | 📅 2025-09-16 - Collection of awesome .NET libraries, tools, frameworks and software.
